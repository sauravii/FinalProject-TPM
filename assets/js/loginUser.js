...
btnLogin.addEventListener("click", function (event) {
  ...
  if (!password) {
    ...
    document.getElementById("input-pass").parentElement.classList.add("error"); // Menambahkan error ke input-eyes
    isValid = false;
    ...
    document.getElementById("input-pass").classList.remove("error");
    document.getElementById("input-pass").parentElement.classList.remove("error"); // Menghapus error dari input-eyes
  }
